...
class DocumentProcessorApp:
    def __init__(self, root):
        ...
        self.type_menu = tk.OptionMenu(root, self.document_type, "Architecture Decision Record", "Anti Patterns", "Benchmarking", "Best Practises",  "Case studies",  "Software Enginnering Literatures",  "Software Architecture Patterns")
